...
class ApiService {
  static const String baseUrl = 'http://localhost:5007/api';
  ...
  Future<Map<String, dynamic>> register(
    ...
    try {
      ...
      print(
        'Request Body: ${json.encode({'username': username, 'email': email, 'password': password})}',
      );
